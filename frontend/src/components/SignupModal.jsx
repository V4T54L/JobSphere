...
const SignupModal = ({ openLoginModal, closeModal }) => {
    ...
    const onSubmit = (e) => {
        ...
        ; (
            async () => {
                try {
                    const resp = await fetch(`${serverBaseUrl}/register`, {
                        method: "POST",
                    ...
                    <div className="p-4 md:p-5">
                        <form className="space-y-4" action="#" onSubmit={onSubmit}>
                            ...
                            <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                                Already have an account? <a href="#" onClick={openLoginModal} className="text-blue-700 hover:underline dark:text-blue-500">Login</a>
                            </div>
                        </form>
                        {
                            error &&
